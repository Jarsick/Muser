...
public class MuserGUI {
	...
	final private static String VERSION = "1.0.0_alpha";
	...
	private void initialize() {
		...
		frmMuser.setBounds(100, 100, 432, 684);
		...
		frmMuser.getContentPane().add(lblMelodyDensity, "2, 18, right, default");
		...
		frmMuser.getContentPane().add(sliderMelodyDensity, "4, 18, left, default");

		var lblMelodyDensityValue = new JLabel("*density");
		lblMelodyDensityValue.setForeground(Color.WHITE);
		frmMuser.getContentPane().add(lblMelodyDensityValue, "5, 18");
		
		JSeparator separator_1 = new JSeparator();
		frmMuser.getContentPane().add(separator_1, "1, 20, 15, 1");
		...
		frmMuser.getContentPane().add(lblBassSettings, "2, 22");
		
		JLabel lblmidiChannel_1 = new JLabel("(MIDI Channel 2)");
		lblmidiChannel_1.setForeground(Color.WHITE);
		frmMuser.getContentPane().add(lblmidiChannel_1, "4, 22");
		...
		frmMuser.getContentPane().add(lblBassInstrument, "2, 24, right, default");

		var comboBoxBassInstrument = new JComboBox<InstrumentName>();
		comboBoxBassInstrument.setFont(new Font("Tahoma", Font.BOLD, 12));
		frmMuser.getContentPane().add(comboBoxBassInstrument, "4, 24, fill, default");
		...
		frmMuser.getContentPane().add(lblBassDensity, "2, 26, right, default");
		...
		frmMuser.getContentPane().add(sliderBassDensity, "4, 26, left, default");
		
		
				var lblBassDensityValue = new JLabel("*density");
				lblBassDensityValue.setForeground(Color.WHITE);
				frmMuser.getContentPane().add(lblBassDensityValue, "5, 26");
				bindLabelToSlider(lblBassDensityValue, sliderBassDensity);
		
		JSeparator separator_3 = new JSeparator();
		frmMuser.getContentPane().add(separator_3, "1, 28, 15, 1");
		...
		frmMuser.getContentPane().add(lblChordsDensity, "2, 34, right, default");
		...
		frmMuser.getContentPane().add(sliderChordsDensity, "4, 34, left, default");
		
				var lblChordsDensityValue = new JLabel("*density");
				lblChordsDensityValue.setForeground(Color.WHITE);
				frmMuser.getContentPane().add(lblChordsDensityValue, "5, 34");
				bindLabelToSlider(lblChordsDensityValue, sliderChordsDensity);
		
		JSeparator separator_2 = new JSeparator();
		frmMuser.getContentPane().add(separator_2, "1, 36, 15, 1");
		...
		frmMuser.getContentPane().add(lblDrumSettings, "2, 38");
		
		JLabel lblmidiChannel = new JLabel("(MIDI Channel 10)");
		lblmidiChannel.setForeground(Color.WHITE);
		frmMuser.getContentPane().add(lblmidiChannel, "4, 38");
		...
		frmMuser.getContentPane().add(lblDrumDensity, "2, 40, right, default");	
		...
		frmMuser.getContentPane().add(sliderDrumDensity, "4, 40, left, default");

		var lblDrumDensityValue = new JLabel("*density");
		lblDrumDensityValue.setForeground(Color.WHITE);
		frmMuser.getContentPane().add(lblDrumDensityValue, "5, 40, left, default");
		...
		frmMuser.getContentPane().add(chckbxDoubleDrumExport, "4, 42");
